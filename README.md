# Weekly Challenge 04: Logical Inference
...
This WC provides practice on deduction using rules of inference. You may need to spend a good amount of time thinking about the problems and it is unlikely that you will arrive at a solution in a single sitting. Start discussing the problem with your buddy early.

# Background

To attempt and submit the task you will need
- to identify atomic propositions in an argument
- to symbolically represent an argument given in natural language
- to apply rules of inference
